...
using Lanting.IDCode.Web.Models.Account;
using Lanting.IDCode.Web.Views.Shared.Components.TenantChange;

namespace Lanting.IDCode.Web.Controllers
{
    public class AccountController : IDCodeControllerBase
    {
